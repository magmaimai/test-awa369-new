...
class Borderless {
    ...
    */
    ...
    public function borderless_load_dependencies() {
        ...
        // 配列かどうかを確認してから処理
        if ( is_array( $options ) ) {
            $primary_color = isset( $options['primary_color'] ) ? $options['primary_color'] : '#0000FF';
            $secondary_color = isset( $options['secondary_color'] ) ? $options['secondary_color'] : '#FF6819';
            $tertiary_color = isset( $options['tertiary_color'] ) ? $options['tertiary_color'] : '#3FCC14';
        } else {
            // 配列でない場合、デフォルトの値を設定
            $primary_color = '#0000FF';
            $secondary_color = '#FF6819';
            $tertiary_color = '#3FCC14';
        }
    ...
    */
    private function borderless_define_public_hooks() {
        ...
        <style type="text/css">
            ...
            :root {
                --borderless-color-primary: <?php echo esc_attr( $primary_color ); ?>;
                --borderless-secondary-primary: <?php echo esc_attr( $secondary_color ); ?>;
                --borderless-color-tertiary: <?php echo esc_attr( $tertiary_color ); ?>;
            }
