...
$navigation_collapsed = $options['navigation_collapsed'] ?: 'navbar-expand-lg';
...
<div class="extra-elements-nav">
    ...
    <ul id="extra-elements-menu" class="navbar-nav justify-content-end">
        ...
        <?php if ( $wishlist >= '2') { ?>
        <li class="nav-wishlist nav-item wishlist-button <?php echo $show_wishlist; ?>">
        ...
        <li class="nav-cart nav-item dropdown <?php echo $show_woo_cart; ?>">
        ...
        <li class="nav-search nav-item dropdown <?php echo $show_search_header; ?>">
        ...
        <li class="nav-side-navigation nav-item <?php echo $show_side_menu; ?>">
