...
$single_post_widget = isset( $options['single_post_widget'] ) ? $options['single_post_widget'] : '3';
$related_posts_switch = isset( $options['related_posts_switch'] ) ? $options['related_posts_switch'] : '';
            ...
            <div id="primary" class="<?php if ( $single_post_widget =='1' ) : ?>col-md-12<?php else : ?>col-md-8<?php endif; ?> content-area">
                ...
                <main id="main" class="site-main" role="main">
                    ...
                    <?php while ( have_posts() ) : the_post(); ?>
                        ...
                        <?php if ($related_posts_switch == true) {

                            get_template_part('module-templates/related-posts'); 
