...
$ReduxFrameworkImages = get_template_directory_uri() . '/vslmd/customizer/img/';
...
$args = array(
    ...
    'menu_type'                 => 'submenu',
    'allow_sub_menu'            => true,
    'menu_title'                => esc_html__( 'Theme Options', 'vslmd' ),
    'page_title'                => esc_html__( 'Theme Options', 'vslmd' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'    => array(
            ...
            array(
                ...
                'options' => array(
                    '1' => array('title' => '', 'img' => $ReduxFrameworkImages . 'header_1.png'),
                    '2' => array('title' => '', 'img' => $ReduxFrameworkImages . 'header_1b.png'),
                    '3' => array('title' => '', 'img' => $ReduxFrameworkImages . 'header_2.png'),
                    '4' => array('title' => '', 'img' => $ReduxFrameworkImages . 'header_2b.png'),
                    '5' => array('title' => '', 'img' => $ReduxFrameworkImages . 'header_3.png'),
                ),
                'default' => '2'
            ),
            array(
            ...
            array(
                ...
                'options' => array(
                    '1' => array('title' => '', 'img' => $ReduxFrameworkImages . '1col.png'),
                    '2' => array('title' => '', 'img' => $ReduxFrameworkImages . '2col.png'),
                    '3' => array('title' => '', 'img' => $ReduxFrameworkImages . '3col.png'),
                    '4' => array('title' => '', 'img' => $ReduxFrameworkImages . '3cm.png'),
                    '5' => array('title' => '', 'img' => $ReduxFrameworkImages . '2cl.png'),
                    '6' => array('title' => '', 'img' => $ReduxFrameworkImages . '2cr.png'),
                ),
                'default' => '2'
            ),
            array(
...
Redux::setSection( $opt_name, array(
    ...
    'fields'    => array(
        ...
        array(
            ...
            'options'   => array(
                'container' => array('alt' => 'Boxed','img' => $ReduxFrameworkImages . '3cm.png'),
                'container-fluid' => array('alt' => 'Stretched', 'img' => $ReduxFrameworkImages . '1col.png')
            ),
            'default'   => 'container'
        ),
    ),
...
Redux::setSection( $opt_name, array(
    ...
    'fields'    => array(
        ...
        array(
            ...
            'options' => array(
                '0' => array('title' => '', 'img' => $ReduxFrameworkImages . 'disable.png'),
                '1' => array('title' => '', 'img' => $ReduxFrameworkImages . '1col.png'),
                '2' => array('title' => '', 'img' => $ReduxFrameworkImages . '2col.png'),
                '3' => array('title' => '', 'img' => $ReduxFrameworkImages . '3col.png'),
                '4' => array('title' => '', 'img' => $ReduxFrameworkImages . '4col.png'),
                '5' => array('title' => '', 'img' => $ReduxFrameworkImages . '2cr.png'),
                '6' => array('title' => '', 'img' => $ReduxFrameworkImages . '2cl.png'),
                '7' => array('title' => '', 'img' => $ReduxFrameworkImages . '3cm.png'),
            ),
            'default' => '3'
        ),
        array(
            ...
            'title' => __('Copyright Text', 'vslmd'), 
            'subtitle' => __('Create your custom footer text', 'vslmd'),
            'default' => 'Copyright [visualmodo_copyright] [visualmodo_current_year] [visualmodo_site_title]. Powered by [visualmodo_theme_author].',
        ),
    ),
) );
Redux::setSection( $opt_name, array(
...
Redux::setSection( $opt_name, array(
    ...
    'fields'    => array(
        array(
            ...
            'subtitle'  => __('Choose the format that works best for you.', 'vslmd'),
            'options'   => array(
                'boxed-layout' => array('alt' => 'Boxed','img' => $ReduxFrameworkImages . '3cm.png'),
                'stretched-layout' => array('alt' => 'Stretched', 'img' => $ReduxFrameworkImages . '1col.png')
            ),
...
Redux::setSection( $opt_name, array(
    ...
    'fields' => array( 
        ...
        array(
            'id' => 'post-type-1-section-start',
            'type' => 'section',
            'title' => esc_html__('Post Type 1', 'vslmd'),
        ...
        array(
            'id'     => 'post-type-1-section-end',
            'type'   => 'section',
            'indent' => false,
        ),

        array(
            'id' => 'post-type-2-section-start',
            'type' => 'section',
            'title' => esc_html__('Post Type 2', 'vslmd'),
        ...
        array(
            'id'     => 'post-type-2-section-end',
            'type'   => 'section',
            'indent' => false,
        ),
    
        array(
            'id' => 'post-type-3-section-start',
            'type' => 'section',
            'title' => esc_html__('Post Type 3', 'vslmd'),
        ...
        array(
            'id'     => 'post-type-3-section-end',
            'type'   => 'section',
            'indent' => false,
        ),

        array(
            'id' => 'post-type-4-section-start',
            'type' => 'section',
            'title' => esc_html__('Post Type 4', 'vslmd'),
        ...
        array(
            'id'     => 'post-type-4-section-end',
            'type'   => 'section',
            'indent' => false,
        ),

        array(
            'id' => 'post-type-5-section-start',
            'type' => 'section',
            'title' => esc_html__('Post Type 5', 'vslmd'),
...
Redux::setSection( $opt_name, array(
    ...
    'fields'    => array(
        ...
        array(
            'id'        => 'post_type_share_twitter_account',
            'type'      => 'text',
            'title'     => __('Twitter Account', 'vslmd'),
            'required' => array('post_type_share_switch','equals','1'),
            'desc'      => __('Input your twitter account without @.', 'vslmd'),
        ),
        array(
            'id'       => 'post_type_share',
            'type'     => 'select',
...
Redux::setSection( $opt_name, array(
    'icon'      => 'el-icon-pencil',
    'subsection' => true,
    'title'     => __('Related Posts', 'vslmd'),
    'desc'      => __('Control and configure the general setup of your Blog.', 'vslmd'),
    'fields'    => array(
        array(
            'id'        => 'related_posts_switch',
            'type'      => 'switch',
            'title'     => __('Related Posts', 'vslmd'),
            'default'   => false,
        ),
        array(
            ...
            'type'      => 'switch',
            'title'     => __('Related Posts Image', 'vslmd'),
            'required' => array('related_posts_switch','equals', true ),
            'default'   => true,
        ),
        array(
            'id'        => 'related_posts_excerpt',
            'type'      => 'switch',
            'title'     => __('Related Posts Excerpt', 'vslmd'),
            'required' => array('related_posts_switch','equals', true ),
            'default'   => true,
        ),
        array(
            ...
            'type' => 'slider',
            'title' => __('Number of Posts to Display', 'vslmd'),
            'desc' => __('Min: 3, max: 12, step: 1, default value: 6', 'vslmd'),
            'required' => array('related_posts_switch','equals', true ),
            "default" => 6,
            "min" => 3,
            "step" => 1,
        ...
        array(
            ...
            'type' => 'slider',
            'title' => __('Limit Post Excerpt Length', 'vslmd'),
            'desc' => __('Min: 10, max: 100, step: 1, default value: 60', 'vslmd'),
        ...
        array(
            ...
            'type' => 'button_set',
            'title' => __('Related Posts Image Resolution', 'vslmd'),
            'desc' => __('Select the best resolution for the images.', 'vslmd'),
            'required' => array('related_posts_image','equals', true ),
            'options' => array(
                'thumbnail' => __('Thumbnail', 'vslmd'),
                'medium' => __('Medium', 'vslmd'),
                'medium-large' => __('Medium Large', 'vslmd'),
                'large' => __('Large', 'vslmd'),
                'full' => __('Full', 'vslmd'),
            ),
            'default' => 'thumbnail'
        ),
        array(
            ...
            'type'      => 'text',
            'title'     => __('Related Posts Heading', 'vslmd'),
            'required' => array('related_posts_switch','equals', true ),
            'desc'      => __('Default is "Recommended For You".', 'vslmd'),
            'default' => ''
        ),
    ),
) );
...
if ($woocommerce) {
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array( 
            array(
                ...
                'desc' => '',
                'options' => array(
                    '0' => array('img' => $ReduxFrameworkImages . '1col.png'),
                    '1' => array('img' => $ReduxFrameworkImages . '2cl.png'),
                    '2' => array('img' => $ReduxFrameworkImages . '2cr.png')
                ),
                'default' => '0'
            ),
            array(
    ...
    Redux::setSection( $opt_name, array(
        'icon'      => 'el-icon-shopping-cart',
        'subsection' => true,
        'title'     => __('Hero Header Shop', 'vslmd'),
        'desc'      => __('Control and configure the general setup of your store.', 'vslmd'),
        'fields'    => array(
            array(
...
Redux::setSection( $opt_name, array(
    'icon'      => 'el-icon-shopping-cart',
    'subsection' => true,
    'title'     => __('Hero Header Products', 'vslmd'),
    'desc'      => __('Control and configure the general setup of your store.', 'vslmd'),
    'fields'    => array(
        array(
            'id'       => 'woo_product_menu_overlay_switch',
            'type'     => 'button_set',
            'title'    => __('Overlay Navigation Menu', 'vslmd'),
            'desc' => __('The menu will overlay the content on top.', 'vslmd'),
            'options' => array(
        ...
        array(
            'id'       => 'woo_product_layout_header_title',
            'type'     => 'button_set',
            'title'    => __('Layout Header Title', 'vslmd'),
            'subtitle'     => __('Organize how you want the layout to appear.', 'vslmd'),
            'options' => array(
        ...
        array(
            'id'        => 'woo_product_header_title_color_overlay',
            'type'      => 'color_rgba',
            'title'     => 'Background Color',
            'required' => array(
                array('woo_product_layout_header_title', '<=', 3),
                array('woo_product_layout_header_title', '!=', 1),
            ),
            'desc'      => 'Set Background Color and Opacity.',
            'output'    => array(
                'background-color' => 'body.woocommerce .header-presentation .hp-background-color'
        ...
        array(         
            'id'       => 'woo_product_header_title_background',
            'type'     => 'background',
            'background-color' => false,
            'required' => array('woo_product_layout_header_title','equals','3'),
            'title'    => __('Background Image', 'vslmd'),
            'desc'     => __('Upload your image should be between 1920px x 1080px (or more) for best results.', 'vslmd'),
            'output'    => array('body.woocommerce .header-presentation'),
        ),  
        array(
            'id'       => 'woo_product_custom_header_title_height',
            'type'     => 'button_set',
            'title'    => __('Header Title Height', 'vslmd'),
            'desc'     => __('Choose the height you want.', 'vslmd'),
            'required' => array(
        ...
        array(
            'id' => 'woo_product_slider_rev_header', 
            'title' => __('Slider Revolution', 'vslmd'),
            'desc' => __('Choose Slide Template', 'vslmd'),
            'required' => array('woo_layout_header_title','equals','4'),
            'type' => 'select',
