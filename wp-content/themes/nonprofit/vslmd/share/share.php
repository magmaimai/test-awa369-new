...
function vslmd_social_sharing_buttons($content) {
	if(is_singular() && !is_page()){
		...
		$post_type_share_twitter_account = $options['post_type_share_twitter_account'] ?: '';
		...
		if ($post_type_share_twitter_account) {
			$twitterURL = 'https://twitter.com/intent/tweet?text='.$vslmdTitle.'&amp;url='.$vslmdURL.'&amp;via='.$post_type_share_twitter_account;
		}
