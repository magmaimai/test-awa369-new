					...
					<nav class="navigation post-navigation row justify-content-between wrapper">
						<?php
							...
							if ( get_previous_post_link() ) {
								previous_post_link( '<span class="btn btn-light">%link</span>', _x( '<i class="fa fa-angle-left"></i>&nbsp;%title', 'Previous post link', 'vslmd' ) );
							}
							if ( get_next_post_link() ) {
								next_post_link( '<span class="btn btn-light">%link</span>',     _x( '%title&nbsp;<i class="fa fa-angle-right"></i>', 'Next post link', 'vslmd' ) );
							}
						?>
					</nav><!-- .nav-links -->
						</div><!-- .navigation -->
