...
class Circular_Progress_Bar extends Widget_Base {
	...
	protected function render() {
        ...
        // Sanitize and escape the Title field to prevent stored XSS
        $raw_title   = $settings['borderless_circular_progress_bar_title'];
        $clean_title = sanitize_text_field( $raw_title );
        $safe_title  = esc_js( $clean_title );

        if ( 'borderless-elementor-circular-progress-bar-stroke-solid-color' === $settings['borderless_circular_progress_bar_stroke_color_style'] ) {
        ...
        echo '<div class="borderless-elementor-circular-progress-bar-widget ' . esc_attr( $settings['borderless_circular_progress_bar_alignment'] ) . '">
            <div class="borderless-elementor-circular-progress-bar ' . esc_attr( $settings['borderless_circular_progress_bar_shape'] ) . '"
                 title="'             . $safe_title                                                                     . '"
                 counter_value="'    . esc_attr( $settings['borderless_circular_progress_bar_counter_value']['size'] )           . '"
                 '                  . $borderless_circular_progress_bar_stroke_color_style                                  . '
                 trail_color="'      . esc_attr( $settings['borderless_circular_progress_bar_trail_color'] )                . '"
                 counter_color="'    . esc_attr( $settings['borderless_circular_progress_bar_counter_color'] )              . '"
                 stroke_width="'     . esc_attr( $settings['borderless_circular_progress_bar_stroke_width']['size'] )      . '"
                 trail_width="'      . esc_attr( $settings['borderless_circular_progress_bar_trail_width']['size'] )       . '"
                 animation_duration="' . esc_attr( $settings['borderless_circular_progress_bar_animation_duration']['size'] ) . '">
            </div>
        </div>';
    }
